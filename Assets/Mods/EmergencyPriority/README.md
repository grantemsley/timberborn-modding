...
<!-- SCREENSHOT: the construction-site priority panel showing the red "!" Emergency toggle next to the standard five priorities -->
...
<!-- SCREENSHOT: a builder beaver asleep on a half-built dam tile, Emergency badge visible on the construction site -->
...
<!-- SCREENSHOT: weather forecast showing incoming badwater with several dam tiles flagged Emergency -->
...
<!-- SCREENSHOT: cycle counter at a low number with a milestone building flagged Emergency -->
...
<!-- SCREENSHOT: a beaver portrait with low needs while still working on an Emergency site -->

## Make sure you have the materials

While *any* Emergency site is unfinished, builders will refuse to start *any* normal-priority construction. That's the whole point — they reserve themselves for the emergency. But it means **if you flag a site Emergency and you don't have the materials to finish it, every construction project in your colony stops** until either the materials show up or you unflag the Emergency.
...
<!-- SCREENSHOT: an Emergency-flagged foundation with idle builders standing around and the materials shortage visible in the building's panel -->
...
<!-- SCREENSHOT: optional title card with the mod name in the game's font -->
